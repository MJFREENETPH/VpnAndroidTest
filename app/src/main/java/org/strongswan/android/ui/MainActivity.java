...
public class MainActivity extends AppCompatActivity implements OnVpnProfileSelectedListener
{
	...
	public X509Certificate parseCertificate(Uri uri) {
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		Uri url = Uri.parse("android.resource://"+getPackageName()+"/raw/ser");

		importCertificate(url);

	//	X509Certificate a = importCertificate(mCertificateUri);
	...
	private static SSLSocketFactory buildSslSocketFactory(Context context) {
		...
		try {
			...
			InputStream is = context.getResources().getAssets().open("content://com.android.externalstorage.documents/document/primary%3ADownload%2Fser.crt");
			...
			return contextt.getSocketFactory();
